...
##### (b) Considere um exemplo da classe positiva, e uma que rede produz como saída os valores [0.5,0,1]. Qual é o valor da cross-entropy este caso?![[l2_exc13b_gn.png]]
...
Quando a identidade não possui o tamanho compatível com a saída a ser somada é realizado o *downsample*. O *downsample* consiste em aplicar convolução na identidade para tornar a dimensão da entrada compatível para a soma com a saída. 
...
Não há evidências na li

### Dúvidas
- Teremos que aplicar em prova o cross entropy?
- Questões: 3, **5**, 21, 33, 34, **35**, 36, 37, 38, **42**. Dar mais foco nas questões > 30.